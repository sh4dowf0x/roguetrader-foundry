const REFERENCE_TABLE_DEFINITIONS = Object.freeze({
  ...
  starshipCombatActions: {
    key: "starshipCombatActions",
    label: "Starship Combat Actions",
    defaultCategory: "reference",
    entries: [
      { min: 1, max: 1, name: "Standard Move", benefit: "Move at half or full Speed; turn at end of move.", description: "Move at half or full Speed. At the end of the move the vessel may turn 90 degrees for Transports, Frigates, and Raiders, or 45 degrees for all other hull types. This is the default move action." },
      { min: 2, max: 2, name: "Adjust Bearing", benefit: "Pilot (Spacecraft)+Manoeuvrability; turn earlier in the move.", description: "Test Pilot (Spacecraft) plus Manoeuvrability. If successful, the vessel may turn 1 plus degrees of success VUs earlier than a Standard Move would normally allow." },
      { min: 3, max: 3, name: "Adjust Speed", benefit: "Pilot (Spacecraft)+Manoeuvrability; increase or decrease Speed.", description: "Test Pilot (Spacecraft) plus Manoeuvrability. If successful, increase or decrease Speed by 1 plus degrees of success, to a minimum of 0." },
      { min: 4, max: 4, name: "Adjust Speed & Bearing", benefit: "-20 Pilot (Spacecraft)+Manoeuvrability; combine Adjust Bearing and Adjust Speed.", description: "Test Pilot (Spacecraft) plus Manoeuvrability at -20. If successful, perform both Adjust Bearing and Adjust Speed during the same move." },
      { min: 5, max: 5, name: "Come About to New Heading", benefit: "-10 Pilot (Spacecraft)+Manoeuvrability; turn mid-move and at end; -20 BS.", description: "Test Pilot (Spacecraft) plus Manoeuvrability at -10. If successful, the ship may turn when it has moved half Speed and again at the end of its move, but suffers -20 Ballistic Skill while doing so." },
      { min: 6, max: 6, name: "Disengage", benefit: "Cannot be used within 8 VUs; opposed Pilot vs Detection+Scrutiny.", description: "Cannot be attempted if another craft is within 8 VUs. Resolve as an opposed Pilot (Spacecraft)+Manoeuvrability test against Detection+Scrutiny within 20 VUs." },
      { min: 7, max: 7, name: "Evasive Manoeuvres", benefit: "-10 Pilot (Spacecraft)+Manoeuvrability; penalize enemy shooting.", description: "Test Pilot (Spacecraft) plus Manoeuvrability at -10. If successful, attacks against the vessel suffer -10, plus an additional -10 per 2 degrees of success, while the ship also takes a Ballistic Skill penalty." },
      { min: 8, max: 8, name: "Active Augury", benefit: "Scrutiny+Detection; scan for bodies, phenomena, and ships within 20 VUs.", description: "Make a Scrutiny plus Detection test to learn information about celestial bodies, phenomena, and ships within 20 VUs, detect Silent Running, and extend scan range by 5 VUs per degree of success." },
      { min: 9, max: 9, name: "Aid the Machine Spirit", benefit: "+5 Manoeuvrability or Detection, plus +5 per 2 DoS.", description: "Appease or direct the vessel's machine spirit to grant +5 to Manoeuvrability or Detection, plus an additional +5 per 2 degrees of success." },
      { min: 10, max: 10, name: "Disinformation", benefit: "-10 Deceive or Blather; 1d5 Morale damage plus 1d5 per DoS.", description: "Use Deceive or Blather at -10 to spread confusion and false orders. On success, inflict 1d5 Morale damage plus 1d5 per degree of success in the appropriate context." },
      { min: 11, max: 11, name: "Emergency Repairs", benefit: "-10 Tech-Use; repair unpowered, damaged, or depressurised Components.", description: "Make a Tech-Use test at -10 to repair an Unpowered, Damaged, or Depressurised Component. Time taken is 1d5 minus degrees of success Turns." },
      { min: 12, max: 12, name: "Flank Speed", benefit: "Tech-Use; +1 VU Speed plus +1 VU per DoS; danger of Engine Crippled.", description: "Use Tech-Use to push the engines. On success, gain +1 VU Speed plus +1 VU per degree of success. On 2 or more degrees of failure the ship suffers an Engine Crippled critical hit." },
      { min: 13, max: 13, name: "Focused Augury", benefit: "Scrutiny+Detection; learn detailed component information within 20 VUs.", description: "Make a Scrutiny plus Detection test against a target within 20 VUs to identify components. Basic success reveals essential components except Auger Arrays and Void Shields; higher degrees reveal more." },
      { min: 14, max: 14, name: "Hail the Enemy", benefit: "Talk to ships within range; may be used by crew involved in manoeuvre or shooting.", description: "Open communications with other ships within range. Characters who participated in manoeuvre or shooting can still perform this Social action." },
      { min: 15, max: 15, name: "Hit & Run", benefit: "Pilot (Spacecraft), -10 per Turret Rating; 5 VU range; Command test on success.", description: "Attempt a strike against an enemy ship within 5 VUs. Resolve Pilot (Spacecraft) at -10 per Turret Rating. On success, make a Command test; if successful, inflict 1d5 Critical Hit x2 and degrees of success Hull Integrity damage." },
      { min: 16, max: 16, name: "Hold Fast!", benefit: "Air of Authority required; Willpower; reduce Morale damage.", description: "Requires Air of Authority. Make a Willpower test; if successful reduce Morale damage by 1, plus degrees of success, to a minimum of 1 for the current turn." },
      { min: 17, max: 17, name: "Jam Communications", benefit: "-10 Tech-Use; target ship cannot use Social sub-type actions.", description: "Use Tech-Use at -10. On success, the targeted ship cannot use Social sub-type actions. Range is 10 VU plus degrees of success." },
      { min: 18, max: 18, name: "Lock on Target", benefit: "Scrutiny+Detection; +5 BS to one weapon component, plus +5 per 2 DoS.", description: "Make a Scrutiny plus Detection test. On success, grant +5 Ballistic Skill to one weapon component, plus +5 per 2 degrees of success." },
      { min: 19, max: 19, name: "Prepare to Repel Boarders!", benefit: "Command; bonus against Boarding Actions while maintained.", description: "Make a Command test. On success, gain +10 Command against Boarding Actions, plus +5 per degree of success, for as long as the action is maintained." },
      { min: 20, max: 20, name: "Put Your Backs Into It!", benefit: "Intimidate or Charm; boost one weapon, repairs, or firefighting.", description: "Use Intimidate or Charm. On success, grant +5 Ballistic Skill to one weapon component or +5 to an Emergency Repairs or Firefighting attempt, plus one additional action per 3 degrees of success." },
      { min: 21, max: 21, name: "Triage", benefit: "-10 Medicae; reduce Crew Population damage.", description: "Make a Medicae test at -10. On success, reduce Crew Population damage by 1, plus degrees of success, to a minimum of 1 for the current turn." },
      { min: 22, max: 22, name: "Silent Running", benefit: "Undetectable except by Augury; manoeuvre penalties and pilot test to move.", description: "The ship attempts to move undetected except by Augury. All Manoeuvre Tests suffer -10; making a Standard Move requires a +10 Pilot (Spacecraft)+Manoeuvrability test; failure on any action reveals the vessel." },
      { min: 23, max: 23, name: "Firefighting", benefit: "-10 Command; remove Fire, optionally by venting into void.", description: "Make a Command test at -10. On success, remove Fire; the crew may choose to vent the affected section into the void to extinguish it." },
      { min: 24, max: 24, name: "Fire Weapons", benefit: "Ballistic Skill; resolve weapon component attacks.", description: "Use Ballistic Skill with any relevant modifiers. One or more characters can fire the ship's weapon components, and the vessel decides the order weapons fire." },
      { min: 25, max: 25, name: "Ramming", benefit: "End move within 1 VU; -20 Pilot (Spacecraft)+Manoeuvrability; both ships take damage.", description: "End movement within 1 VU of another vessel, then test Pilot (Spacecraft)+Manoeuvrability at -20. On success, inflict ramming damage based on hull size and Prow Armour. The ramming ship also takes 1d5 plus Armour damage." },
      { min: 26, max: 26, name: "Boarding", benefit: "End move within 1 VU; opposed Command after Pilot test; deal Crew/Morale or HI damage.", description: "End movement within 1 VU of another vessel and test Pilot (Spacecraft)+Manoeuvrability to tangle and board. Resolve opposed Command with modifiers for crew, Hull Integrity, and Turret Rating. Inflict Crew Population and Morale damage, or Hull Integrity damage, based on success." },
      { min: 27, max: 27, name: "Control the Weak Mind", benefit: "Compel power; force a nearby ship to fire one weapon at a chosen target.", description: "Requires the Compel psychic power. Make the listed Focus Power test to force a weapon on another vessel within range to fire at a target chosen by the Astropath, then suffer Astropath Fatigue." },
      { min: 28, max: 28, name: "Dark Labyrinth", benefit: "Delude power; ship counts as in a Tenebro-Maze.", description: "Requires the Delude power. Make the listed Focus Power test; on success the target ship counts as navigating a Tenebro-Maze for 1 plus degrees of success Turns, then suffer Astropath Fatigue." },
      { min: 29, max: 29, name: "Divining the Way", benefit: "Divination power; add 1d5 DoS to a Manoeuvre Action.", description: "Requires Divination. Make the listed Focus Power test; on success add 1d5 degrees of success to a Manoeuvre Action, once per combat." },
      { min: 30, max: 30, name: "Flash Fire", benefit: "Telekinesis power; set a random component on fire.", description: "Requires Telekinesis. Make the listed Focus Power test; on success one random component on a vessel within range catches fire, then suffer Astropath Fatigue." },
      { min: 31, max: 31, name: "Ill-Omens", benefit: "Terrify power; inflict Morale damage in response to boarding.", description: "Requires the Terrify power. Make the listed Focus Power test in response to a Boarding Action; on success inflict 1d5 Morale damage plus degrees of success, then suffer Astropath Fatigue." },
      { min: 32, max: 32, name: "Inspiring Presence", benefit: "Inspire power; boost pilot or command during hit and run.", description: "Requires the Inspire power. Make a Focus Power test; on success add +10 percent times degrees of success to either Pilot (Spacecraft) or Command during a Hit & Run Action." },
      { min: 33, max: 33, name: "Mask of the Void", benefit: "Delude power; penalize enemy Astropaths and a chosen vessel.", description: "Requires the Delude power. Make the listed Focus Power test; on success choose one vessel within range to suffer Ballistic Skill penalties and hostile Astropaths to suffer penalties, then suffer Astropath Fatigue." },
      { min: 34, max: 34, name: "Psychic Deflection", benefit: "Telekinesis power; gain extra Void Shield against one shot.", description: "Requires Telekinesis. Make the listed Focus Power test; on success the ship counts as having 1 plus degrees of success extra Void Shield against one shot, then suffer Astropath Fatigue." },
      { min: 35, max: 35, name: "Quell Flames", benefit: "Telekinesis power; extinguish fire.", description: "Requires Telekinesis. Make the listed Focus Power test; on success extinguish 1 fire, plus more depending on degrees of success, then suffer Astropath Fatigue." },
      { min: 36, max: 36, name: "Taking the Shot", benefit: "Divination power; grant +10% shooting for the combat.", description: "Requires Divination. Make the listed Focus Power test; on success grant +10% Shooting Action during the entire combat." },
      { min: 37, max: 37, name: "Telepathic Jamming", benefit: "Focus Power; jam astro-telepathic signals in a radius.", description: "Make the listed Focus Power test to interfere with astro-telepathic signals in a radius measured in VUs, opposing attempts to send or receive them." },
      { min: 38, max: 38, name: "The Ties that Bind", benefit: "Mind Link power; +5 to all players for next Strategic Round.", description: "Requires Mind Link. Make a Willpower Focus Power test; on success grant +5 to all players for the next Strategic Round." },
      { min: 39, max: 39, name: "Unnatural Resolve", benefit: "Inspire power; restore Morale.", description: "Requires Inspire. Make the listed Focus Power test; on success restore 1d5 Morale plus degrees of success, once per game session, then suffer Astropath Fatigue." },
      { min: 40, max: 40, name: "Emergency Jump", benefit: "-30 Navigation (Warp); translate into the Warp to escape.", description: "Make a Navigation (Warp) test at -30 in response to enemy shooting. On success the vessel immediately translates into the Warp until next turn; on failure it suffers inaccurate re-entry and possible Warp incursion." },
      { min: 41, max: 41, name: "Relentless Pursuit", benefit: "-10 Navigation (Stellar); reduce DoS needed to catch in Stern Chase.", description: "Make a Navigation (Stellar) test at -10. Each degree of success reduces the degrees needed to catch an enemy in a Stern Chase." },
      { min: 42, max: 42, name: "Scanning the Aether", benefit: "-10 Psyniscience; Active Augury with extended range.", description: "Make a Psyniscience test at -10 to perform Active Augury out to Psyniscience Bonus times 3 VUs. If the vessel's Augury is damaged or destroyed, it functions until next turn for this test." },
      { min: 43, max: 43, name: "Tactical Positioning", benefit: "-10 Psyniscience; add DoS to shooting or evasive manoeuvres.", description: "Make a Psyniscience test at -10. On success add 1 degree of success to a successful Ballistic Skill test or 1 degree of success to successful Evasive Manoeuvres." },
      { min: 44, max: 44, name: "Tactical Retreat", benefit: "-10 Navigation (Stellar); reduce DoS needed to escape in Stern Chase.", description: "Make a Navigation (Stellar) test at -10. Every 2 degrees of success reduces the degrees of success needed to escape in a Stern Chase." },
      { min: 45, max: 45, name: "Warp Interference", benefit: "-20 Psyniscience; reduce a vessel's Detection for several rounds.", description: "Make a Psyniscience test at -20. Choose one vessel within range; on success it suffers -10 Detection for 1 plus degrees of success Rounds." }
    ]
  },
  malignancies: {
    key: "malignancies",
